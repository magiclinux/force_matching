...
def Plot_Trajectories(pm):
    ...
    plt.tight_layout()
    plt.savefig('figures/trajectory_12_halfmoons.pdf', format='pdf', bbox_inches='tight')
...
def draw_plot(rectified_flow, test_dataset, N=None):
  ...
  plt.tight_layout()
  plt.savefig('figures/12_halfmoons.pdf', format='pdf', bbox_inches='tight')
