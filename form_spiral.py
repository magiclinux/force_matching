...
def Plot_Trajectories(pm):
    ...
    plt.tight_layout()
    plt.savefig('figures/trajectory_form_spiral.pdf', format='pdf', bbox_inches='tight')
...
def draw_plot(rectified_flow, test_dataset, N=None):
  ...
  plt.tight_layout()
  plt.savefig('figures/form_spiral.pdf', format='pdf', bbox_inches='tight')
